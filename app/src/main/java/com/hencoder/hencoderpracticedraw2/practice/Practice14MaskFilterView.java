...
public class Practice14MaskFilterView extends View {
    ...
    Bitmap bitmap;
    MaskFilter blurMaskFilter1 = new BlurMaskFilter(50, BlurMaskFilter.Blur.NORMAL);
    MaskFilter blurMaskFilter2 = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
    MaskFilter blurMaskFilter3 = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
    MaskFilter blurMaskFilter4 = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
